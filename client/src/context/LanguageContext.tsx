...
export const translations: Translations = {
  ...
  medicalReports: { zh: '医疗报告', en: 'Medical Reports' },
  healthSummary: { zh: '健康总结', en: 'Health Summary' },
  ...
  // 健康总结报告页面
  healthSummaryTitle: { zh: '健康总结报告', en: 'Health Summary Report' },
  healthSummaryDesc: { zh: '基于您的数据自动生成的周报、月报、年报', en: 'Auto-generated weekly, monthly, and annual reports based on your data' },
  generateWeekly: { zh: '生成周报', en: 'Weekly' },
  generateMonthly: { zh: '生成月报', en: 'Monthly' },
  generateAnnual: { zh: '生成年报', en: 'Annual' },
  noReportsYet: { zh: '暂无报告，点击上方按钮生成', en: 'No reports yet, click above to generate' },
  needDataHint: { zh: '需要至少一周的健康数据才能生成报告', en: 'At least one week of health data is required to generate a report' },
  summary: { zh: '总结', en: 'Summary' },
  keyMetrics: { zh: '关键指标', en: 'Key Metrics' },
  avgWeight: { zh: '平均体重', en: 'Avg Weight' },
  avgSteps: { zh: '日均步数', en: 'Avg Steps' },
  sleepScore: { zh: '睡眠评分', en: 'Sleep Score' },
  heartRate: { zh: '心率', en: 'Heart Rate' },
  goodPoints: { zh: '表现良好', en: 'Good Points' },
  improvementPoints: { zh: '需要改进', en: 'Areas to Improve' },
  healthRisks: { zh: '健康风险提示', en: 'Health Risk Alerts' },
  healthSuggestions: { zh: '健康建议', en: 'Health Suggestions' },
  totalDays: { zh: '共', en: 'Total' },
  daysRecorded: { zh: '天记录', en: 'days' },
  selectXAndY: { zh: '请选择 X 轴和 Y 轴字段', en: 'Please select X and Y axis' },
  
  // 医疗报告页面
  medicalReportsTitle: { zh: '医疗数据报告', en: 'Medical Data Reports' },
  medicalReportsDesc: { zh: '上传 CSV/JSON/Excel 文件，自动识别日期并生成图表', en: 'Upload CSV/JSON/Excel files, auto-detect dates and generate charts' },
  uploadFile: { zh: '上传文件', en: 'Upload File' },
  noReports: { zh: '暂无报告', en: 'No reports' },
  uploadHint: { zh: '点击上方按钮上传您的医疗数据文件', en: 'Click the button above to upload your medical data file' },
  supportedFormats: { zh: '支持 CSV、JSON、Excel 格式', en: 'Supports CSV, JSON, Excel formats' },
  reportName: { zh: '报告名称', en: 'Report Name' },
  description: { zh: '描述（可选）', en: 'Description (Optional)' },
  cancel: { zh: '取消', en: 'Cancel' },
  uploading: { zh: '上传中...', en: 'Uploading...' },
  upload: { zh: '上传', en: 'Upload' },
  deleteConfirm: { zh: '确定要删除这个报告吗？', en: 'Are you sure you want to delete this report?' },
  dataCount: { zh: '数据项数', en: 'Data count' },
  viewChart: { zh: '查看图表', en: 'View Chart' },
  delete: { zh: '删除', en: 'Delete' },
  dataFile: { zh: '数据文件', en: 'Data File' },
  dataFileRequired: { zh: '数据文件 *', en: 'Data File *' },
  ...
  barChart: { zh: '柱状图', en: 'Bar Chart' },
  pieChart: { zh: '饼图', en: 'Pie Chart' },
  scatterChart: { zh: '散点图', en: 'Scatter Chart' },
  xAxis: { zh: 'X 轴（时间）', en: 'X Axis (Time)' },
  yAxis: { zh: 'Y 轴（数值）', en: 'Y Axis (Value)' },
  selectXAxis: { zh: '请选择 X 轴', en: 'Please select X axis' },
  selectYAxis: { zh: '请选择 Y 轴', en: 'Please select Y axis' },
  noDateField: { zh: '未检测到日期字段', en: 'No date field detected' },
  dateFieldDetected: { zh: '已自动识别日期字段', en: 'Date field auto-detected' },
  dataVisualization: { zh: '数据可视化', en: 'Data Visualization' },
  ...
  totalRecordsShort: { zh: '共', en: 'Total' },
  ...
  // 管理面板
  adminPanelTitle: { zh: '管理面板', en: 'Admin Panel' },
