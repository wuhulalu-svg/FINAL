...
export function Login({ onLogin, onShowRegister }: LoginProps) {
  ...
  const handleSendCode = async () => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/password/send-code', {
        method: 'POST',
            ...
            {step === 'email' && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all disabled:opacity-50"
                >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    maxLength={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-center text-2xl tracking-widest"
                  />
                  {countdown > 0 && (
                    <p className="text-xs text-gray-500 mt-2">Resend available in {countdown}s</p>
                  )}
                </div>
                <button
                ...
                <button
                  ...
                  className="w-full text-indigo-600 py-2 text-sm hover:text-indigo-700 transition-colors disabled:opacity-50"
                >
                  Resend Code
                </button>
              </div>
